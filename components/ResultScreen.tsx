...
export default function ResultScreen({ result, onBackToTitle }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center gap-4 overflow-y-auto bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 p-4">
      <h1
        className={`text-5xl font-black tracking-widest drop-shadow-lg sm:text-6xl ${
              ...
              result.heroes
                ...
                .map((h, i) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-2 text-center text-slate-300">{h.level}</td>
                    <td className="px-2 py-2 text-center font-mono text-slate-200">
